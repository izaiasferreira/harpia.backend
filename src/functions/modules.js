const AVAILABLE_MODULES = [
    ...
    { id: 'create_justify_pending', name: 'Criar Justificativa de Pendência', group: 'Justificativa de Pendência' },
    ...
    { id: 'create_daily_report', name: 'Criar Diário de Bordo', group: 'Diário de Bordo' },
    ...
    { id: 'create_inventory', name: 'Criar Inventário', group: 'Inventário' },
    ...
    { id: 'users', name: 'Usuários', group: 'Usuários e Colaboradores' },
    { id: 'create_user', name: 'Criar Usuário', group: 'Usuários e Colaboradores' },
    { id: 'update_user', name: 'Atualizar Usuário', group: 'Usuários e Colaboradores' },
    { id: 'delete_user', name: 'Deletar Usuário', group: 'Usuários e Colaboradores' },
    { id: 'users_agents', name: 'Consultar Agentes', group: 'Usuários e Colaboradores' },
    { id: 'create_user_agent', name: 'Criar Agente', group: 'Usuários e Colaboradores' },
    { id: 'update_user_agent', name: 'Atualizar Agente', group: 'Usuários e Colaboradores' },
    { id: 'delete_user_agent', name: 'Deletar Agente', group: 'Usuários e Colaboradores' },
    { id: 'bulk_update_user_agent', name: 'Edição em Massa de Agentes', group: 'Usuários e Colaboradores' },
    { id: 'manage_agents', name: 'Gerenciar Status/Situação de Agentes', group: 'Usuários e Colaboradores' },
    ...
    { id: 'create_security_report', name: 'Criar Relatório de Segurança', group: 'Segurança e Monitoramento' },
    ...
    { id: 'forms', name: 'Consultar Formulários', group: 'Formulários e Checklists' },
    { id: 'create_form', name: 'Criar Formulário', group: 'Formulários e Checklists' },
    { id: 'update_form', name: 'Atualizar Formulário', group: 'Formulários e Checklists' },
    { id: 'delete_form', name: 'Deletar Formulário', group: 'Formulários e Checklists' },
    { id: 'delete_form_response', name: 'Deletar Resposta de Formulário', group: 'Formulários e Checklists' },
    { id: 'checklists', name: 'Consultar Checklists de Segurança', group: 'Formulários e Checklists' },
    { id: 'create_checklist', name: 'Responder / Criar Checklist', group: 'Formulários e Checklists' },
    { id: 'manage_checklist_templates', name: 'Gerenciar Templates de Checklist', group: 'Formulários e Checklists' },
    { id: 'delete_checklist_template', name: 'Deletar Template de Checklist', group: 'Formulários e Checklists' },
    { id: 'delete_checklist', name: 'Excluir Checklist', group: 'Formulários e Checklists' },
    { id: 'create_agent_exemption', name: 'Criar Isenção de Checklist (Agentes)', group: 'Formulários e Checklists' },
    { id: 'delete_agent_exemption', name: 'Excluir Isenção de Checklist (Agentes)', group: 'Formulários e Checklists' },
    { id: 'view_agent_exemptions', name: 'Visualizar Isenções de Checklist (Agentes)', group: 'Formulários e Checklists' },
    // Serviços
    ...
    { id: 'geofences', name: 'Cercas Virtuais (Visualização)', group: 'Serviços' },
    { id: 'create_geofence', name: 'Criar Cerca Virtual', group: 'Serviços' },
    { id: 'update_geofence', name: 'Atualizar Cerca Virtual', group: 'Serviços' },
    { id: 'delete_geofence', name: 'Deletar Cerca Virtual', group: 'Serviços' },
    // Auditoria e App
