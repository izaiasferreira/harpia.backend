const AVAILABLE_MODULES = [
    ...
    { id: 'create_security_accident', name: 'Criar Reporte de Acidente', group: 'Segurança e Monitoramento' },
    { id: 'service_annotations', name: 'Consultar Anotações de Serviço', group: 'Segurança e Monitoramento' },
    { id: 'create_service_annotation', name: 'Criar Anotação de Serviço', group: 'Segurança e Monitoramento' },
    { id: 'delete_service_annotation', name: 'Deletar Anotação de Serviço', group: 'Segurança e Monitoramento' },
    { id: 'resolve_service_annotation', name: 'Resolver / Validar Anotações de Serviço', group: 'Segurança e Monitoramento' },
