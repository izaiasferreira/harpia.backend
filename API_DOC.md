...
| **[11. APIs de Acidentes](docs/ACCIDENTS.md)** | Registro de acidentes do agente (FAB longo-press) e gestão administrativa. | `/agent/accident`, `/admin/tracking/accidents/*`. |
